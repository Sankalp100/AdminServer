(function() {
  ...
  angular.module('app4').controller('dietitiansController', dietitiansController);
  
  dietitiansController.$inject = ['$scope', '$http'];
  

function dietitiansController ($scope, $http) {
